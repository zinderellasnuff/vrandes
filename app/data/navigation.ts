 ...
 * Navigation Data
 *
 * Datos de navegación y enlaces sociales.
 * Estos datos se usan en Header, Footer, BottomNav y SocialBar.
 */
 ...
 * Se definen como strings para poder usarlos en componentes de servidor y cliente
 */
export const icons = {
  ...
  tours: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
 ...
 */
export type NavSectionId = 'hero' | 'tours' | 'about' | 'gallery' | 'contact';

/**
 * Configuración de navegación principal
 */
export const navSections: NavSectionId[] = ['hero', 'tours', 'about', 'gallery', 'contact'];

/**
 * Mapeo de sección a ícono
 */
export const sectionIcons: Record<NavSectionId, string> = {
  hero: icons.home,
  tours: icons.tours,
  about: icons.about,
...
/**
 * Obtener items de navegación con labels del diccionario
 */
export function getNavItems(dict: Dictionary) {
  return navSections.map((id) => ({
    id,
    label: dict.nav[id === 'hero' ? 'home' : id],
