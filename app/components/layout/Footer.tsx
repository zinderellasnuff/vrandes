...
const socialLinks = [
  ...
  {
    name: 'Facebook',
    href: 'https://facebook.com/vintageridesandes',
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
  ...
  {
    name: 'YouTube',
    href: 'https://youtube.com/@vintageridesandes',
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
      ...
      <div className="footer__container container">
        ...
        <div className="footer__content reveal">
          ...
          <div className="footer__brand">
            <Link href={`/${lang}`} className="footer__logo">
          ...
          <div className="footer__social">
            <span className="footer__social-title">{dict.footer.followUs}</span>
        ...
        <div className="footer__bottom">
          <p className="footer__copyright">
            © {currentYear} Vrandes. {dict.footer.copyright}
          </p>
          <div className="footer__legal">
            <Link href={`/${lang}/privacidad`} className="footer__legal-link">
              {dict.footer.privacy}
            </Link>
            <span className="footer__legal-separator">·</span>
            <Link href={`/${lang}/terminos`} className="footer__legal-link">
              {dict.footer.terms}
            </Link>
          </div>
        </div>
